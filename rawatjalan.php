...
<head>
    ...
    <title>Input Rawat Jalan - SiKlinik</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            <form method="post">
                <div class="container">
                    <h1>Input Rawat Jalan</h1>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <label for="tahunmasuk">Tahun Masuk</label>
                                <input type="date" class="form-control" id="tahunmasuk" placeholder="a"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="keluhanpasien" placeholder="Silahkan Isi"
                                    name="keluhanpasien" autocomplete="off" required>
