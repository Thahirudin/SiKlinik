...
include 'koneksi.php';
$c = mysqli_query($koneksi, "select * from rawat_inap");
$i = 1; ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Data Rawat Inap- SiKlinik</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
            <div class="container table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php while ($rowrawatinap = mysqli_fetch_assoc($c)) :
                        $id_pasien = $rowrawatinap['id_pasien'];
                        $id_petugas = $rowrawatinap['id_petugas'];
                        ...
                        $rowpasien = mysqli_fetch_assoc($a);
                        $rowpetugas = mysqli_fetch_assoc($b);
                    ?>
                        <tr>
                            <th scope="row"><?php echo $i ?></th>
                            <td><?php echo $rowpasien['nama_pasien'] ?></td>
                            <td><?php echo $rowpetugas['nama'] ?></td>
                            <td><?php echo $rowrawatinap['kelas'] ?></td>
                            <td><?php echo $rowrawatinap['tanggal_masuk'] ?></td>
                            <td><?php echo $rowrawatinap['tanggal_keluar'] ?></td>
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="editrawatinap.php?id=<?php echo $rowrawatinap["id"]?>"
                                    ...
                                    <a href="cetakrawatinap.php?id=<?php echo $rowrawatinap["id"]?>"
                                    ...
                                    <a href="hapusrawatinap.php?id=<?php echo $rowrawatinap["id"]?>"
