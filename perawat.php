...
<head>
    ...
    <title>Input Perawat - SiKlinik</title>
    <!-- Favicon icon -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" class="form-control" id="namapetugas" placeholder="Silahkan Isi"
                                        name="namapetugas" autocomplete="off" required>

                                </div>
                                <div class="form-floating mb-3" hidden>
                                    <label for="jabatan">Jabatan</label>
                                    <input type="text" class="form-control" id="jabatan" placeholder="Silahkan Isi"
                                ...
                                <div class="form-floating mb-3"> <label for="tanggallahir">Tanggal lahir</label>
                                    ...
                                    <input type="date" class="form-control" id="tanggallahir" placeholder="silahkan isi"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="number" class="form-control" id="nomotelepon"
                                        placeholder="silahkan isi" name="nomortelepon" autocomplete="off" required>

                                </div>
                                <div class="form-floating mb-3"> <label for="password">Password</label>

                                    <input type="password" class="form-control" id="password" placeholder="silahkan isi"
