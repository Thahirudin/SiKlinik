...
if (isset($_POST['submit'])) {
    ...
    // Melakukan validasi apakah code tersebut sudah digunakan
    $sql         = "SELECT * FROM obat WHERE kode_obat = '$kodeobat' ";
    $result_cek    = mysqli_query($koneksi, $sql);
    $total_cek     = mysqli_num_rows($result_cek);
    
    if($total_cek){
        echo "<script>
        alert('Kode Sudah Digunakan!');
        document.location.href = 'inputobat.php';
      </script>";
    }else{
...
<head>
    ...
    <title>Input Obat - SiKlinik</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="container">
                    <h1>Input Obat</h1>
                    <form method="post">
                        <div class="form-floating mb-3"><label for="kodeobat">Kode Obat</label>
                            <input type="text" class="form-control" id="kodeobat" placeholder="Silahkan Isi"
                                name="kodeobat" autocomplete="off" required>

                        </div>
                        <div class="form-floating mb-3"> <label for="namaobat">nama Obat</label>
                            <input type="text" class="form-control" id="namaobat" placeholder="Silahkan Isi"
                                name="namaobat" autocomplete="off" required>
