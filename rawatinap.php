...
if (isset($_POST['submit'])) {
    if (tambahrawatinap($_POST) > 0) {
      echo "
          <script>
            alert('Data Rawat Inap Berhasil Ditambahkan!');
      ...
      echo "
          <script>
            ...
            document.location.href = 'rawatinap.php';
          </script>
      ";
    }
} ?>
...
<head>
    ...
    <title>Input Rawat Inap - SiKlinik</title>
    <!-- Favicon icon -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" aria-label=".form-select-lg example" name="kelas">
                                    <script>
                                    for (let i = 1; i <= 15; i++) {
                                        document.write("<option value=" + i + "> kelas " + i + "</option>")
                                    }
                                    </script>
                                </select>
                            </div>
