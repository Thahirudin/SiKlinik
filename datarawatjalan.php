...
include 'koneksi.php';
$a = mysqli_query($koneksi, "select * from rawat_jalan");
$i = 1; ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Data Rawat Jalan - SiKlinik</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
            <div class="table-responsive p-3">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php while ($rowrawatjalan = mysqli_fetch_assoc($a)) :
                        $id_pasien = $rowrawatjalan['id_pasien'];
                        $id_obat = $rowrawatjalan['id_obat'];
                        $id_petugas = $rowrawatjalan['id_petugas'];
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="cetakrawatjalan.php?id=<?php echo $rowrawatjalan["id"]?>"
                                    ...
                                    <a href="hapusrawatjalan.php?id=<?php echo $rowrawatjalan["id"]?>"
