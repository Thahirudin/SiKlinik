...
$a = mysqli_query($koneksi, "select * from petugas where jabatan = 'dokter'"); 
$b = mysqli_query($koneksi, "select * from pasien"); 
$c = mysqli_query($koneksi, "select * from obat"); 
...
<head>
    ...
    <title>Input Dokter - SiKlinik</title>
    <!-- Favicon icon -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3"><label for="namapetugas">Nama petugas</label>
                                    <input type="text" class="form-control" id="namapetugas"
                                        placeholder="Silahkan Di Isi" name="namapetugas" autocomplete="off" required>

                                </div>
                                <div class="form-floating mb-3" hidden><label for="jabatan">Jabatan</label>
                                    <input type="text" class="form-control" id="jabatan" placeholder="Silahkan Di Isi"
                                        name="jabatan" autocomplete="off" required value="Dokter">

                                </div>
                                <div class="form-floating mb-3"><label for="tanggallahir">Tanggal lahir</label>
                                    <input type="date" class="form-control" id="tanggallahir"
                                        placeholder="Silahkan Di Isi" name="tanggallahir" autocomplete="off" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3"> <label for="alamat">Alamat</label>
                                    <input type="text" class="form-control" id="alamat" placeholder="Silahkan Di Isi"
                                ...
                                <div class="form-floating mb-3"> <label for="nomotelepon">Nomor Telepon</label>
                                    <input type="number" class="form-control" id="nomotelepon"
                                        placeholder="Silahkan Di Isi" name="nomortelepon" autocomplete="off" required>

                                </div>
                                <div class="form-floating mb-3"><label for="password">Password</label>
                                    <input type="password" class="form-control" id="password"
                                        placeholder="Silahkan Di Isi" name="password" autocomplete="off" required>
