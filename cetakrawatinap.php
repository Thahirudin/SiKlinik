...
include 'koneksi.php';
$id  = $_GET['id'];
$a = mysqli_query($koneksi, "select * from rawat_inap where id = '$id' ");
...
<body>
    <div class="container">
        <div>
            <h1 style="text-align: center;">Data Rawat Inap</h1>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-1">:</div>
            <div class="col"><?php echo $rawatjalan['tanggal_masuk'] ?></div>
        </div>
        <div class="row">
            <div class="col-2">Tanggal keluar</div>
            <div class="col-1">:</div>
            <div class="col"><?php echo $rawatjalan['tanggal_keluar'] ?></div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-2">Ruang Kelas</div>
            <div class="col-1">:</div>
            <div class="col"><?php echo $rawatjalan['kelas'] ?></div>
        </div>
    </div>
    <script>
    window.print();
