...
include 'koneksi.php';
$a = mysqli_query($koneksi, "select * from petugas where jabatan = 'perawat'"); 
...
<head>
    ...
    <title>Data Perawat - SiKlinik</title>
    <!-- Favicon icon -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="editperawat.php?id_petugas=<?php echo $row["id_petugas"]?>"
                                    ...
                                    <a href="cetakpetugas.php?id_petugas=<?php echo $row["id_petugas"]?>"
                                    ...
                                    <a href="hapuspetugas.php?id_petugas=<?php echo $row["id_petugas"]?>"
